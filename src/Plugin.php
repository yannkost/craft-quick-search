                    ...
                    $view->registerJs(
                        'window.QuickSearchSettings = ' . json_encode([
                            ...
                            'translations' => [
                                ...
                                'searchResults' => Craft::t('quick-search', 'Search Results'),
                                'enterToSearch' => Craft::t('quick-search', 'Enter ↵'),
                                'close' => Craft::t('quick-search', 'Close'),
                                'closeDrawer' => Craft::t('quick-search', 'Close drawer'),
                                'dragToReorder' => Craft::t('quick-search', 'Drag to reorder'),
                                'historyError' => Craft::t('quick-search', 'Error loading history'),
                                ...
                                'slug' => Craft::t('quick-search', 'Slug'),
                                'status' => Craft::t('quick-search', 'Status'),
                                'live' => Craft::t('quick-search', 'Live'),
                                'disabled' => Craft::t('quick-search', 'Disabled'),
                                'draft' => Craft::t('quick-search', 'Draft'),
                                'postDate' => Craft::t('quick-search', 'Post Date'),
                                'expiryDate' => Craft::t('quick-search', 'Expiry Date'),
                                'save' => Craft::t('quick-search', 'Save'),
                                // Admin type labels
                                'adminSection' => Craft::t('quick-search', 'Section'),
                                'adminField' => Craft::t('quick-search', 'Field'),
                                'adminEntryType' => Craft::t('quick-search', 'Entry Type'),
                                'adminCategoryGroup' => Craft::t('quick-search', 'Category Group'),
                                'adminVolume' => Craft::t('quick-search', 'Volume'),
                                'adminGlobalSet' => Craft::t('quick-search', 'Global Set'),
                                'adminPlugin' => Craft::t('quick-search', 'Plugin'),
                                // Favorites shortcuts
        ...
        Event::on(
            ...
            function(DefineHtmlEvent $event) {
                try {
                    ...
                    $event->html = '<button type="button" class="quick-search-related-btn btn" data-entry-id="' . (int)($entry->getCanonicalId() ?? $entry->id) . '" title="' . htmlspecialchars($buttonLabel, ENT_QUOTES, 'UTF-8') . '">' .
                        '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">' .
